...
/**
 * Camera control
 * return: is the shooter ready to fire
 */
bool MyRobot::CameraControl(void)
{
   printf("In CameraControl\n");
...
void MyRobot::startTracking()
{
   m_cameraChecker->Start((INT32)this);
}

void MyRobot::stopTracking()
{
   m_cameraChecker->Stop();
}
...
if (targetStatus == 0)
{
   ...
   {
      voltageToDriveShooter = 5.275914116
            * exp(0.0286983122 * distanceToTarget);
   }
...
void MyRobot::autonomouslyDriveShooter(int targetStatus,
   double distanceToTarget, double voltageToDriveShooter, double valueToRotate)
{
